/**
 * The majority of this file (in PCars::SharedMemory) are
...
namespace PCars
{
	...
	{
	public:
		SharedMemoryData::SharedMemory* game;
		static constexpr char* MAP_OBJECT_NAME = "$pcars$";
